# Computational Skepticism for AI — Wayback Sections

> ARCHIVED 2026-07-02. The AI Wayback Machine sections were REMOVED from all chapters
> and now live as per-figure mini-bio source files in this folder (see README.md).
> This whole-book extraction predates the removal and the 13-chapter renumbering.
> Do not re-run extraction — there is nothing left in the chapters to extract.
