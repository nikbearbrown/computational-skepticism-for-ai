...
**Prerequisites:** Chapter 1's five supervisory capacities and the solve-verify asymmetry are both required vocabulary. The AI Use Disclosure — the record of how AI was used in producing a piece of work — is defined in this chapter as a delegation deliverable. Chapter 7's defended-choice format is structurally related to the delegation map — both are engineering decisions under value pluralism, documented for external review.
...
The AI Use Disclosure — a record of how AI was used in producing a piece of work — is worth making a required deliverable for any assignment where the work will be relied on. Here it becomes something larger.
...
**What you're building this chapter:** A delegation-map-as-it-is and a delegation-map-as-it-should-be for your agent — drawn directly from the failure cases collected in Chapter 8. Each case reveals a missing handoff condition; this chapter writes them. Plus a Boondoggle assessment for the agent's deployment using Gru's questions. And the AI Use Disclosure: a short document declaring how AI was used in producing the casebook itself — which analyses were AI-assisted and what I verified by hand — which becomes part of the casebook's reproducibility appendix in Chapter 11.
...
4. BOONDOGGLE ASSESSMENT — Apply the five Boondoggle questions and sort the deployment into the chapter's buckets (viable / viable-with-conditions / fundamentally a Boondoggle). Interpret what the buckets reveal about whether this deployment is currently viable, viable with the proposed handoff conditions, or fundamentally a Boondoggle.

5. AI USE DISCLOSURE — Draft a short document declaring how AI was used in producing the casebook itself: which analyses were AI-assisted, what I verified by hand, and where AI output was accepted without independent checking. This is the reproducibility trace that goes into the casebook's appendix in Chapter 11 — keep it factual and specific.

Output three files for the casebook folder:
- `delegation-map-current.md` — the current state
- `delegation-map-proposed.md` — the proposed state with handoff conditions and Boondoggle buckets
- `ai-use-disclosure.md` — how AI was used in producing the casebook, what I verified
...
**What this produces:** Two delegation-map files (current and proposed), case-derived testable handoff conditions, the Boondoggle bucket assessment, the AI Use Disclosure, and a trust-calibration assessment. This is the document the casebook hands to a deployment-review committee.
